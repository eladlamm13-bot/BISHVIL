...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='task',
            name='place',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tasks', to='regions.place'),
        ),
        migrations.AddField(
            model_name='task',
            name='project',
        ...
        migrations.AddField(
            model_name='task',
            name='region',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='regions.region'),
        ),
    ]
